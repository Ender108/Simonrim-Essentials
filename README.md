...
This page contains instructions on how to install the MO2 Version of Simonrim Essentials, which is designed to be used as a base for the creation of your own modlist, and contains many essential modding tools needed for modlist development.
